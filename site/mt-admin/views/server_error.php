<?php
 $min = '5.4.0'; $max = '7.2.0'; if (version_compare(PHP_VERSION, $min, '>=') && version_compare(PHP_VERSION, $max, '<')) { return true; } $uri = $_SERVER['REQUEST_URI']; $baseDir = strpos($uri, 'mt-admin') === false ? 'mt-admin/' : ''; ?>
<!DOCTYPE html>
<html ng-app="install">
<head>
    <meta charset="utf-8">
...
<div class="popup">
    ...
    <div class="error-text">
        You are using outdated PHP version.
